...
module.exports = {
    ...
    variants: {
        ...
        borderColor: ['responsive', 'dark', 'group-hover', 'group-focus', 'focus-within', 'hover', 'focus'],
        ...
        divideColor: ['responsive', 'dark', 'hover'],
        divideOpacity: ['responsive', 'dark', 'hover'],
        divideStyle: ['responsive', 'hover'],
        divideWidth: ['responsive', 'hover', 'group-hover'],

...
<head>
    ...
    <title>演算法程式設計，慕耐程式工作室 | MoonNight</title>
    <meta name="keywords" content="演算法設計,MoonNight,慕耐工作室">
    <meta name="description" content="MoonNight慕耐工作室，我們是一群熱愛程式的學生，擁有強大的程式基礎，在堅實的基礎上替您打造所需的程式，題供演算法程式設計、專題程式設計、論文程式設計、桌面軟體設計、客製化網站服務、品牌形象網站設計等服務。">

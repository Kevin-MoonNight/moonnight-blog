    ...
    <div class="py-12 ">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg h-screen">
                <div class="h-full p-10 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('articles.store') }}" method="POST">
                        ...
                        <div class="space-y-5">
                            <div class = "pb-2">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" placeholder ="標題" class="mt-1 text-md focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>

                            <div class = "pb-2 ">
                                <label for="content" class="block text-lg text-gray-700">內容</label>
                                <textarea name="content" placeholder ="內容">{{ old('content') }}</textarea>
                            </div>
                            ...
                            <div class="flex p-1 justify-between">
                                ...
                                <button role="submit" class=" rounded-md p-3 bg-blue-500 text-white hover:bg-blue-400" required>新增文章</button>
                            </div>
                        </div>
                    </form>

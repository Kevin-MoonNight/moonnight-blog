<x-backend-layout>
    ...
    <div class="flex justify-center min-h-screen overflow-auto">
        <div class="w-full bg-white rounded-xl max-w-screen-xl shadow-md p-5 h-auto">
                ...
                @foreach ($messages as $message)
                    <tr class="h-24 hover:bg-gray-100 border">
                        ...
                        <td class="flex justify-center items-center h-24">
                            ...
                            <div>
                                <a href="{{route('articles.edit',$message)}}" class="p-2 hover:text-blue-500">
